...
maxsqlDf = hsqlContext.sql("select idcard,"
                           ...
                           "from personal_cfsl_loan_deduct_seq_max_mid yy group by yy.idcard")


save_path = output_feature_hdfs_path + key_cal
keySeconds = maxsqlDf.rdd.map(lambda row: dropFrame(row))
keySeconds.repartition(500).saveAsTextFile(save_path)
